    ...
    <div class="max-w-4xl px-4 py-6 mx-auto bg-white rounded shadow-md lg:mt-10 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('players.update', $player->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="position" id="position" value="{{ old('position', $player->position) }}"
                    class="block w-full px-3 py-2 mt-1 text-gray-700 border border-gray-300 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="national" id="national" value="{{ old('national', $player->national) }}"
                    class="block w-full px-3 py-2 mt-1 text-gray-700 border border-gray-300 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500"
