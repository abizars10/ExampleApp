    ...
    <div class="flex flex-col justify-center min-h-full px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="w-auto h-10 mx-auto" src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=600"
                alt="Your Company">
            <h2 class="mt-5 font-bold tracking-tight text-center text-gray-900 text-2xl/9">Register to your account</h2>
        </div>
        ...
        <div class="relative mt-5 border-2 rounded-lg shadow-xl sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="m-5 " action="{{ route('register') }}" method="POST">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <label for="password" class="block font-medium text-gray-900 text-sm/6">Confirm Password</label>
                    </div>
                    <div class="mt-2">
                ...
                <div>
                    <button type="submit"
                        class="flex w-full mt-4 justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register Now</button>
                </div>

                 <div>
                    <div class="flex items-center justify-center text-sm">
                        <label for="password" class="block font-medium text-gray-900 text-sm/6">Already have an account? <a href="/login" class="font-semibold text-indigo-600 hover:text-indigo-500">Sign In
                        </a>
                        </label>
                    </div>
                </div>
