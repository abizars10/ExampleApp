    <nav x-data="{ isOpen: false }" class="bg-gray-800">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:block">
                    <div class="flex items-center ml-4 md:ml-6">
                        <div class="ml-3">
                            ...
                            @auth
                                <div class="font-medium text-white text-base/5">{{ Auth::user()->name }}</div>
                            @endauth
                        </div>
                ...
                <div class="flex -mr-2 md:hidden">
                    ...
                    <button @click="isOpen = !isOpen" type="button"
                        ...
                        <svg :aria-checked="isOpen" :class="{ 'hidden': isOpen, 'block': !isOpen }" class="block size-6"
                        ...
                        <svg :aria-checked="isOpen" :class="{ 'block': isOpen, 'hidden': !isOpen }"
        ...
        <div x-show='isOpen' class="md:hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a href="dashboard" class="block px-3 py-2 text-base font-medium text-white bg-gray-900 rounded-md"
                    aria-current="page">Dashboard</a>
                <a href="team"
